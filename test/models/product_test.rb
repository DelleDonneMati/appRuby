...
class ProductTest < ActiveSupport::TestCase
  ...
  test "codigo unico" do
    # assert Product.new(unicode: 'ABC123456', descrip:'', detail:'', price: 0, name:'').save
    assert_not Product.new(unicode: 'ABC123456', descrip:'', detail:'', price: 0, name:'').valid?, "El Codigo se repite"
  end
