...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { client_id: @phone.client_id, number: @phone.number } }, as: :json
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { client_id: @phone.client_id, number: @phone.number } }, as: :json
    assert_response 200
  end
